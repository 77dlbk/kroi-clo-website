...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (viewport && track) {
    ...
    const catalogMetaData = [
      ...
      { // Card 7 (Index 6)
        title: "Классическое алое пальто",
        category: "Верхняя одежда / Пальто",
        fabrics: "Шерсть, альпака",
        desc: "Яркое алое пальто классического двубортного кроя. Износостойкий и мягкий материал высочайшего качества с шелковистым блеском.",
        images: ["assets/catalog-7.jpg"]
      },
      { // Card 8 (Index 7)
